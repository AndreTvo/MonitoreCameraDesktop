...
private:
	...
	static const uint MinBatchSize = 512;						// tamanho mínimo do lote de sprites
	static const uint MaxBatchSize = 8192;						// tamanho máximo do lote de sprites	
	static const uint VerticesPerSprite = 4;					// número de vértices por imageSprite
	static const uint IndicesPerSprite = 6;						// número de índices por imageSprite
...
public:
	...
	void Draw(SpriteInfo & sprite);								// adiciona imageSprite na lista
	bool Render();												// envia sprites para desenho	
};
